  ...
  return (
    <Content>
      <div className={cx('row')}>
        ...
        <Text
          label={`${formatNumber(chargeAmount)} ${TOTAL_CULTURE_AMOUNT.CHARGE_UNIT_WON}`}
        />
      </div>
      <div className={cx('row')}>
        <Text label={TOTAL_CULTURE_AMOUNT.CHARE_FEE} />
        <Text
          label={`${formatNumber(chargeFee)} ${TOTAL_CULTURE_AMOUNT.CHARGE_UNIT_WON}`}
        />
      </div>
      ...
      <div className={cx('row')}>
        ...
        <Text
          label={`${formatNumber(totalAmount)} ${TOTAL_CULTURE_AMOUNT.CHARGE_UNIT_CASH}`}
          type="headlineBold"
        />
      </div>
    </Content>
